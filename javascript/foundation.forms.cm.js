  ...
  Foundation.libs.forms = {
    ...
    toggle_radio: function ($element) {
        ...
        if (false === $input.is(':disabled')) {
		  ...
		  /* Added by CM */
		  $form.find('input[type="radio"][name="' + this.escape($input.attr('name')) + '"]').parent('label').removeClass("active").addClass("unactive");
		  $label.removeClass("unactive").addClass("active");
